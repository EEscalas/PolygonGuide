...
**Note:** In our CodeSprintLA problem creation, we have decided that by default the first three test cases of your test case script will be the example test cases for your problem.
